...
-include vendor/onda/OndaMid/BoardConfigVendor.mk
...
BOARD_EGL_CFG := device/onda/OndaMid/egl.cfg
USE_OPENGL_RENDERER := true
ENABLE_WEBGL := true
BOARD_USE_SKIA_LCDTEXT := true

# CWM
#TARGET_RECOVERY_INITRC := device/onda/OndaMid/recovery.init.rc
#BOARD_HAS_NO_SELECT_BUTTON := true
#BOARD_UMS_LUNFILE := "/sys/class/android_usb/android0/f_mass_storage/lun0/file"
#RECOVERY_USE_CHUNESE_FONT := true
...
TARGET_PREBUILT_KERNEL := device/onda/OndaMid/kernel
BOARD_KERNEL_BASE := 0x10000000
BOARD_KERNEL_CMDLINE := 

TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := device/onda/OndaMid/releasetools/amlogic_ota_from_target_files
