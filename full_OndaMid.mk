...
DEVICE_PACKAGE_OVERLAYS := device/onda/OndaMid/overlay
...
# USB ModeSwitch
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/onda/OndaMid/configs/usb_modeswitch.d,system/etc/usb_modeswitch.d)

# Prebuilt kernel modules
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/onda/OndaMid/modules,system/lib/modules)
...
$(call inherit-product-if-exists, vendor/onda/OndaMid/OndaMid-vendor.mk)
